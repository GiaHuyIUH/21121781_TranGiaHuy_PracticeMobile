...
function* fetchTodos() {
    try {
        const response = yield call(fetch, 'https://66ff62072b9aac9c997f1c11.mockapi.io/api/v1/todos');
...
function* deleteTodoSaga(action) {
    ...
    try {
        yield call(fetch, `https://66ff62072b9aac9c997f1c11.mockapi.io/api/v1/todos/${id}`, { method: 'DELETE' });
